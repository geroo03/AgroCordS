    ...
    <section className="shadow-extruded rounded-xl bg-white p-4">
      ...
      <div className="mt-3 space-y-4">
        {[...grupos.entries()].map(([dia, delDia]) => (
          <div key={dia}>
            <p className="mb-1 text-[18px] font-semibold text-tinta">{etiquetaDia(dia)}</p>
            ...
            {delDia.length === 24 ? (
              <div className="flex text-[12px] text-tinta/50">
                {["00", "06", "12", "18"].map((t) => (
      ...
      <div className="mt-3 flex flex-wrap gap-x-4 gap-y-1 text-[14px] text-tinta/70">
