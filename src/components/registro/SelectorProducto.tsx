...
const CLASE_SELECT =
  "min-h-11 w-full rounded-lg border border-niebla bg-papel px-3 text-base outline-none focus:border-pizarra disabled:opacity-50";
...
export default function SelectorProducto({ tipo, onTipo, seleccion, onSeleccion }: Props) {
  ...
  return (
    <section aria-label="Producto a aplicar">
      ...
      <div className="relative mt-3">
        <label className="block">
          <span className="mb-1 block text-base font-semibold">Buscar producto</span>
          <input
            type="search"
            value={busqueda}
      ...
      <label className="mt-3 block">
        <span className="mb-1 block text-base font-semibold">Principio activo</span>
        <select
      ...
      <label className="mt-3 block">
        <span className="mb-1 block text-base font-semibold">Nombre comercial</span>
        <select
