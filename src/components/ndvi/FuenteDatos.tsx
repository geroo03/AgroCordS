...
export default function FuenteDatos({
  ...
  if (serie.real) {
    return (
      <div className="shadow-extruded rounded-xl bg-white p-3 text-[16px]">
        <p className="text-[14px] text-tinta/60">Fuente</p>
        <p className="font-semibold text-optima">🛰 Sentinel-2 · Copernicus</p>
        {ultima ? (
          <dl className="mt-2 grid grid-cols-2 gap-2">
            <div>
              <dt className="text-[14px] text-tinta/60">Última observación</dt>
              <dd className="font-semibold tabular-nums">{fechaLegible(ultima.fecha)}</dd>
            </div>
            <div>
              <dt className="text-[14px] text-tinta/60">Nubes sobre el lote</dt>
            ...
            {ultima.confianza !== null ? (
              <div className="col-span-2">
                <dt className="text-[14px] text-tinta/60">Respaldo del valor</dt>
  ...
  return (
    <div className="shadow-sunken rounded-xl bg-[#f4f6fa] p-3 text-[16px] text-tinta/80">
      <p className="text-[14px] text-tinta/60">Fuente</p>
